            ...
            <div className="mt-6 w-full max-w-2xl rounded-lg overflow-hidden shadow-lg bg-gray-100">
                <div className="px-8 py-10">
                    ...
                    <p className="text-gray-600 mb-4">
                        YumExpress is a food-ordering website that leverages the
                        Swiggy API, a renowned food ordering platform. By
                        blending technology with culinary expertise, YumExpress
                        provides users a seamless and enjoyable platform for
                        discovering, ordering, and relishing delicious meals
                        from various eateries.
                    </p>
                    <ul className="list-disc list-inside text-gray-600 mb-4">
                        <li className="mb-2">
                            Enjoy a sleek and user-friendly interface for
                            effortless browsing and ordering.
                        </li>
                        <li className="mb-2">
                            Discover your favorite restaurants or explore new
                            dining options with ease.
                        </li>
                        <li className="mb-2">
                            Customize orders to your preferences, from
                            traditional comfort food to exotic international
                            flavors.
                        </li>
                    </ul>
                    <p className="text-gray-600">
                        Looking ahead, YumExpress plans to expand its offerings
                        by integrating an API to provide users with access to
                        diverse recipes, further enhancing the culinary
                        experience.
                    </p>
                </div>
            </div>
